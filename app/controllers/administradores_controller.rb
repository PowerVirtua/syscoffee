class AdministradoresController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to administradores_path, status: :see_other, notice: "Administrador was successfully destroyed." }
  ...
  private
    ...
    def administrador_params
      params.require(:administrador).permit(:tipo, :nome, :sobrenome, :identificacao, :celular1, :celular2, :telefone_fixo, :razao_social, :nome_fantasia, :representante_legal, :data_cadastro, :rua, :numero, :complemento, :bairro, :cidade, :estado, :email, :senha, :confirmar_senha)
    end
end
